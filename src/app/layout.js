...
export const metadata = {
  ...
  title: {
    default: "DevImpact Hackathon 2025 | NCS Club",
    template: "%s | DevImpact 2025",
  },
  description:
    "🚀 Join the most exciting hackathon at NIT Rahmania! 72 hours of non-stop innovation, coding challenges, mentorship, and amazing prizes. Connect with fellow developers, build groundbreaking projects, and make a lasting impact! 💻✨",
  keywords: [
    "hackathon",
    "coding competition",
    "tech innovation",
    ...
    <html lang="en" className={inter.variable}>
      <head>
        ...
        <meta
          ...
          content="DevImpact Hackathon - Where Developers Make an Impact"
        />
