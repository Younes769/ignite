...
const Hero = ({ onRegisterClick }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto text-center mt-44">
      {/* Title */}
      <div 
        className={`
      ...
      <p 
        className={`
          text-xl md:text-2xl text-white/60 mt-12 mb-16 leading-relaxed 
          max-w-2xl mx-auto transform transition-all duration-1000 delay-700 ease-out
          ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}
        `}
      >
        Join us for{" "}
      ...
      >
        <button 
          ...
          className="group relative w-full sm:w-auto min-w-[220px] hover:-translate-y-0.5 transition-all duration-300"
        >
          ...
          <span className="relative flex items-center justify-center gap-3 px-10 py-4 rounded-xl bg-emerald-500/90 hover:bg-emerald-500 transition-all duration-300">
            <span className="font-semibold text-lg">Join the Challenge</span>
        ...
        >
          ...
          <span className="relative flex items-center justify-center gap-3 px-10 py-4 rounded-xl border-2 border-white/10 hover:border-emerald-500/30 hover:text-emerald-400/90 transition-all duration-300">
      ...
      <div 
        className={`
          absolute top-1/3 left-10 w-72 h-72 bg-emerald-500/5 rounded-full 
      ...
      <div 
        className={`
          absolute top-1/3 right-10 w-72 h-72 bg-emerald-400/5 rounded-full 
