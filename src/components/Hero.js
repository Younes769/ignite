...
const Hero = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto text-center mt-12 sm:mt-24 px-4 sm:px-6 lg:px-8">
      {/* Title */}
      <div
        className={`
      ...
      >
        Join us for{" "}
        <span className="text-emerald-400/90 font-medium">three days</span> of
        creation, innovation, and breakthrough moments.
      </p>
      ...
      >
        ...
        >
          ...
          <span className="relative flex items-center justify-center gap-3 px-8 sm:px-10 py-4 rounded-xl border-2 border-white/10 hover:border-emerald-500/30 hover:text-emerald-400/90 transition-all duration-300">
            ...
            <span className="opacity-0 group-hover:opacity-100 transform group-hover:translate-x-1.5 transition-all duration-300">
              →
            </span>
          </span>
        </button>
